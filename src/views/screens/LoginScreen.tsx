...
import type { AuthControllerCallbacks } from '../../models';

export interface LoginScreenProps extends AuthControllerCallbacks {}

const logoImage = require('../../../assets/images/defendulogo.png');
